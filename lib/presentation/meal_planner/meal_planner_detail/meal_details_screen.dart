...
Future<Map<String, dynamic>> getDishDetails(int id) async {
  String url =
      'http://192.168.64.186:8055/items/dish/$id?fields=*,difficulty_id.*,nutritions.*,nutritions.nutrition_id.*,ingredients.*,ingredients.ingredient_id.*,process_steps.*&filter[status][_neq]=archived';
          ...
          return [
            ...
            SliverAppBar(
              ...
              flexibleSpace: Container(
                ...
                child: Image.network(
                  'http://192.168.64.186:8055/assets/${widget.dObj["image"]}',
                                    ...
                                    return InkWell(
                                      ...
                                      child: Container(
                                        ...
                                        child: Row(
                                          children: [
                                            Image.network(
                                              'http://192.168.64.186:8055/assets/${yObj["nutrition_id"]["image"].toString()}',
                                              width: 20,
                                              height: 20,
                                              fit: BoxFit.contain,
                                            ),
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          Container(
                                            ...
                                            child: Image.network(
                                              'http://192.168.64.186:8055/assets/${yObj["ingredient_id"]["image"].toString()}',
                                              width: 50,
                                              height: 50,
                                              fit: BoxFit.contain,
                                            ),
