...
class _WorkoutScheduleViewState extends State<WorkoutScheduleView> {
  ...
  String createWorkoutScheduleUrl(DateTime date) {
    ...
    return 'http://192.168.102.186:8055/items/workout_schedule?filter[_and][0][_and][0][status][_neq]=archived&filter[_and][0][_and][1][user_id][_eq]=\$CURRENT_USER&filter[_and][0][_and][2][scheduled_execution_time][_gte]=$startDate&filter[_and][0][_and][3][scheduled_execution_time][_lte]=$endDate';
  }
        ...
        leading: InkWell(
          onTap: () {
            Navigator.pushReplacement(
                context,
                MaterialPageRoute(
                    builder: (context) => const DashboardScreen(initialTab: DashboardTab.workout,)));
          },
          child: Container(
