...
Future<Workout> getWorkoutDetail(int id) async {
  String url = 'http://192.168.64.186:8055/api/workouts/$id?difficulity=EASY';
    ...
    if (response.statusCode == 200) {
      ...
      List<Exercise> exercises = (workoutData['exercises'] as List).map((exercise) {
        ...
        return Exercise(
          ...
          image: 'http://192.168.64.186:8055/assets/${exerciseId['image']}',
      ...
      List<Equipment> equipments = (workoutData['equipments'] as List).map((equipment) {
        ...
        return Equipment(
          ...
          image: 'http://192.168.64.186:8055/assets/${equipmentId['image']}',
        );
      }).toList();
      return Workout(
