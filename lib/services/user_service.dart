...
class UserService {
  static const String baseUrl = 'http://192.168.133.103:8055/users/me';
  ...
  Future<int> getCompletedExerciseId(
    ...
    final response = await http.get(
      Uri.parse(
          'http://192.168.133.103:8055/items/workout_schedule_exercise?workout_schedule_id=$workoutScheduleId&exercise_id=$exerciseId'),
      headers: {
        'Authorization': 'Bearer $token',
        'Content-Type': 'application/json'
      },
